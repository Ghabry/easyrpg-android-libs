...
# Mp3 via libmad
SUPPORT_MP3_MAD := true
MAD_LIBRARY_PATH := ../libmad-0.15.1b
...
ifeq ($(SUPPORT_MIDI),true)
    ...
    LOCAL_SRC_FILES += \
		$(TIMIDITY_LIBRARY_PATH)/android.c \
        $(TIMIDITY_LIBRARY_PATH)/common.c \
        $(TIMIDITY_LIBRARY_PATH)/ctrlmode.c \
		$(TIMIDITY_LIBRARY_PATH)/filter.c \
		$(TIMIDITY_LIBRARY_PATH)/instrum.c \
		$(TIMIDITY_LIBRARY_PATH)/mix.c \
		$(TIMIDITY_LIBRARY_PATH)/output.c \
		$(TIMIDITY_LIBRARY_PATH)/playmidi.c \
		$(TIMIDITY_LIBRARY_PATH)/readmidi.c \
		$(TIMIDITY_LIBRARY_PATH)/resample.c \
		$(TIMIDITY_LIBRARY_PATH)/sdl_a.c \
		$(TIMIDITY_LIBRARY_PATH)/sdl_c.c \
		$(TIMIDITY_LIBRARY_PATH)/tables.c \
		$(TIMIDITY_LIBRARY_PATH)/timidity.c
endif
